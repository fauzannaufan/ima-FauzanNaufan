export default {
    "db-config": {
        "sd_TtOHHkMFFcjyiYvv": {
            ...
            "postgres_host": process.env.dbUrl,
            "postgres_port": 5432,
            "postgres_username": process.env.dbUsername,
            "postgres_password": process.env.dbPassword,
            ...
            "users": {
                "SSD_SERVICE_ID_sd_021vYcqlWhwA3RZa": [
                    "sd_Fi4y6cl0fA20EGtV",
                    "sd_fWYNeNt5gELcotf8"
                ]
            }
